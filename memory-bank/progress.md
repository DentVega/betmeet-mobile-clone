...
- Bolts (Planned): V1 i18n ✅ · V2 Settings+Profile ✅ · V3 Results&Auto-scoring ✅ · V4 Realtime&Live ✅ · V5 Pool-Depth backend ✅ · V6 Pool-Depth mobile ✅ · V7 Account&Security ✅ · V8 Avatar upload (native) · V9 Passkeys/biometrics (native) · V10 Notifications/push (native). **V7 done → Next: V8 (first native bolt).**
